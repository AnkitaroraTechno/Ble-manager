  ...
  const connectToPeripheral = peripheral => {
    BleManager.createBond(peripheral.id)
      .then(() => {
        ...
        // After successful pairing, connect to the peripheral
        BleManager.connect(peripheral.id)
          .then(() => {
            console.log('Connected to', peripheral.name, 'with ID:', peripheral.id);
          })
          .catch(error => {
            console.log('Failed to connect to', peripheral.name, 'with ID:', peripheral.id);
            console.error(error);
          });
      })
      .catch(() => {
